...
def update():
    top = Toplevel()
    top.title("Update")
    #creating label in update
    f_name_label1 = Label(root, text = "First Name")
    f_name_label1.grid(row = 0, column = 0)
    l_name_label1 = Label(root, text = "Last Name")
    l_name_label1.grid(row = 1, column = 0)
    address_label1 = Label(root, text="Address")
    address_label1.grid(row=2, column=0)
    city_label1 = Label(root, text="City")
    city_label1.grid(row=3, column=0)
    state_label1 = Label(root, text="State")
    state_label1.grid(row=3, column=0)

    #creating text boxes in update
...
update_btn.grid(row = 13, column = 0, columnspan = 2, pady = 10, padx = 10, ipadx= 100)
